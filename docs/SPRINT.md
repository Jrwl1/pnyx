...
- [ ] Rewrite home hero, trust section, and party discovery labels in citizen-facing language
  ...
  - evidence: HARD BLOCKED: dirty baseline outside files-scope (`design/FRONTEND_AUDIT.md`).
