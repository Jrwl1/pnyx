...
Repo: V1 spec locked (amended by CR-002). M0, M1, M2, and M3 are delivered; post-S3 lifecycle hardening is recorded as S4.

Current mode: Roadmap (S5 Active)
...
- Execute S5 in DO mode per `ai/workflows/DO_MODE.md` and `ai/roadmap/SPRINT.md` (`S5-T01..S5-T10`).
